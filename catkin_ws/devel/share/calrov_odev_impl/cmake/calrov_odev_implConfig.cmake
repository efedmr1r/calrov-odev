...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'calrov_odev_impl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thunderstorm010/calrov-odev/catkin_ws/src/calrov_odev_impl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/thunderstorm010/calrov-odev/catkin_ws/devel/lib;/home/thunderstorm010/calrov-odev/catkin_ws/devel/lib;/home/thunderstorm010/mambaforge/envs/ros_env/lib)

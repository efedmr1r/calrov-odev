...
if("TRUE" STREQUAL "TRUE")
  set(mypackage_SOURCE_PREFIX /home/aakif/python_catkin/src/mypackage)
  set(mypackage_DEVEL_PREFIX /home/aakif/python_catkin/devel)
  ...
  set(mypackage_INSTALL_PREFIX /home/aakif/python_catkin/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'aakif <aakif@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mypackage' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aakif/python_catkin/src/mypackage/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aakif/python_catkin/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mypackage_EXPORTED_TARGETS ${${mypackage_dep}_EXPORTED_TARGETS})
endforeach()
